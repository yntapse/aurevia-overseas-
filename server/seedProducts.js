export const seedProducts = [
  {
    ...
    description:
      'Fresh, high-quality red onions sourced from the finest farms in India. Our red onions are known for their rich flavor, firm texture, and extended shelf life.',
    image_url:
  ...
  },
  {
    ...
    category: 'Agricultural Products',
    description:
      'Premium quality groundnuts (peanuts) available in shell and shelled forms. Rich in protein and healthy fats.',
    image_url:
  ...
  },
  {
    ...
    description:
      "Authentic handmade Indian handicrafts including textiles, pottery, metalwork, and wooden artifacts. Each piece reflects traditional Indian craftsmanship.",
    image_url:
